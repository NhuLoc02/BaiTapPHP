                ...
                <div class="row">
                        ...
                        <div class="product-detail__media">
                            <div class="media__items d-flex">
                                <div class="media__item product-image-container w-100">
                                    <img class="w-100" src="admin/uploads/product/<?php echo $row_product_detail['product_image'] ?>" alt="image product" />
                    ...
                    <div class="col" style="--w-md: 6">
                        <div class="product-detail__info">
                            <form method="POST" action="pages/controllers/AddCartController.php?product_id=<?php echo $row_product_detail['product_id'] ?>">
