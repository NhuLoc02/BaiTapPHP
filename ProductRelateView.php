<?php
class ProductView {
    public function renderProductList($productList, $evaluateRatings) {
?>
                    ...
                    <div class="product__card d-flex flex-column">
                        <div class="product__image p-relative">
                            <a href="index.php?page=product_detail&product_id=<?php echo $row['product_id'] ?>">
                                <img class="w-100 h-100 object-fit-cover" src="admin/uploads/product/<?php echo $row['product_image'] ?>" alt="product image" />
                            </a>
                            <?php
