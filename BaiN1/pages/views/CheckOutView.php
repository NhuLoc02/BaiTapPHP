...
<section class="checkout pd-section">
    <div class="container">
        <form action="pages/handle/CheckOutHandle.php" method="POST">
            <div class="row">
                            ...
                            ?>
                                    <div class="checkout__item d-flex align-center">
                                        <div class="checkout__image p-relative">
                                            ...
                                            <a href="index.php?page=product_detail&product_id=<?php echo $cart_item['product_id'] ?>"><img class="w-100 d-block object-fit-cover ratio-1" src="admin/uploads/product/<?php echo $cart_item['product_image'] ?>" alt=""></a>
                                        </div>
