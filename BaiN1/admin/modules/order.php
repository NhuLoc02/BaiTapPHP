...
if (isset($_GET['confirm']) && $_GET['confirm'] == 1) {
    if ($order_codes) {
        ...
        header('Location: ../../admin/index.php?action=order&query=order_list&message=success');
        ...
        header('Location: ../../admin/index.php?action=order&query=order_detail_online&order_code=' . $_GET['order_code'] . '&message=success');
    }
}

if (isset($_GET['rollback']) && $_GET['rollback'] == 1) {
    header('Location: ../../admin/index.php?action=order&query=order_detail_online&order_code=' . $_GET['order_code'] . '&message=info');
}
...
if (isset($_SESSION['order']) && isset($_GET['delete'])) {
    ...
    foreach ($_SESSION['order'] as $order_item) {
        ...
        header('Location:../../admin/index.php?action=order&query=order_add&message=success');
    }
}
// xoa tat ca
...
if (isset($_POST['order_add'])) {
    ...
    if ($validate == 1) {
        ...
        unset($_SESSION['order']);
        header('Location:../../admin/index.php?action=order&query=order_detail&order_code=' . $order_code . '&message=success');
    } else {
        header('Location:../../admin/index.php?page=404');
    }
}
...
if (isset($_GET['reverse']) && $_GET['reverse'] == 1) {
    ...
    header('Location: ../../admin/index.php?action=order&query=order_payment&message=success');
}
