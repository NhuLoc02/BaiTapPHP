...
<div class="dialog__control">
    <div class="control__box">
        <a href="modules/OrderListphp?confirm=1" class="button__control" id="btnConfirm">Duyệt đơn hàng</a>
        <a href="modules/OrderListphp?cancel=1" class="button__control" id="btnCancel">Hủy đơn hàng</a>
    </div>
</div>
<script>
    ...
    function getCheckedCheckboxes() {
        ...
        btnConfirm.href = "modules/order.php?confirm=1&data=" + JSON.stringify(checkedIds);
        btnCancel.href = "modules/order.php?cancel=1&data=" + JSON.stringify(checkedIds);
    }
</script>
