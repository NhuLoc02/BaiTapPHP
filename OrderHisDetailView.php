<div class="row" style="margin-bottom: 10px;">
    <div class="col d-flex" style="justify-content: space-between; align-items: flex-end;">
        ...
        <a href="index.php?action=order&query=order_payment" class="btn btn-outline-dark btn-fw">
                ...
                <div class="card-content">
                    <div class="checkout">
                        ...
                        <?php
                            foreach ($getByIds as $row) {
                            ?>
                        <a href="?action=order&query=order_print&checked_ids=<?php $row['order_code'] ?>" target="_blank" class="btn btn-outline-dark btn-fw">In Hóa Đơn</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
