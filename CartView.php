            ...
            <div class="cart__container">
                ...
                <div class="cart__content">
                    ...
                    ?>
                            <div class="cart__item d-grid">
                                <div class="cart__image">
                                    <a href="index.php?page=product_detail&product_id=<?php echo $cart_item['product_id'] ?>"><img class="w-100" src="admin/uploads/product/<?php echo $cart_item['product_image'] ?>" alt="product" /></a>
                                </div>
