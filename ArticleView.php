...
class ArticleView {
                ...
                <div class="row">
                    <div class="col">
                        <div class="article__img--item">
                            <img class="w-100 d-block object-fit-cover" src="admin/upload/blog/<?php echo $article['article_image'] ?>" alt="image article">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col">
                        <div class="article__content d-flex justify-center">
                            <div class="article__container pd-section">
                                <h1 class="article__heading h2"><?php echo $article['article_title'] ?></h1>
                                <span class="article__date d-block"><?php echo $article['article_date'] ?></span>
    ...
    public function renderComments($comments, $comment_total) {
        ?>
                    ...
                    <div class="blog__comment">
                        <div class="comment__container">
                            ...
                            <div class="comment__items">
                                <?php while ($comment_item = mysqli_fetch_array($comments)) { ?>
