...
class ProductController 
{
    ...
    {
        $brand_id = isset($_GET['brand_id']) ? $_GET['brand_id'] : null;
        $brand1s = $productModel->getBrand1();
        global $productModel;
        if (isset($_POST['product_add'])) {
            ...
            $product_sale= $_POST['product_sale'];
            $product_description= $_POST['product_description'];
            $productModel->addProduct($product_name, $product_price, $product_price_import, $product_status, $product_sale, $product_description, $brand_name, $category_name, $capacity_name);
