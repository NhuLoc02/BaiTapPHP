...
<div class="row">
                ...
                <div class="card-content">
                    <form action="" method="POST">
                                ...
                                <table class="table table-hover table-action">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td>
                                                        <a href="models/InventoryModel.php?delete=<?php echo $inventory_item['product_id'] ?>">
                                                            <div class="icon-edit">
                        ...
                        <div class="w-100 d-flex align-center space-between">
                            ...
                            <a href="models/InventoryModel.php?deleteall=1">Xóa tất cả</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="col-lg-4 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="card-content">
                    <form action="models/InventoryModel.php" method="POST">
